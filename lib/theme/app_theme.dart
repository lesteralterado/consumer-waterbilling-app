...
/// A class that contains all theme configurations for the water utility billing application.
/// Implements the "Trusted Utility" color theme with "Purposeful Clarity" design approach.
class AppTheme {
  AppTheme._();

  // Primary color palette - Trusted Utility theme
  static const Color primaryLight = Color(0xFF1B4B8C); // Deep utility blue
  static const Color primaryVariantLight =
      Color(0xFF0F3A6B); // Darker blue variant
  ...
  static const Color primaryVariantDark = Color(0xFF1B4B8C);
  ...
  static const Color errorDark =
      Color(0xFFEF5350); // Lighter error red for dark mode
  ...
  static const Color textDisabledLight =
      Color(0xFF9CA3AF); // Light gray disabled text

  static const Color textPrimaryDark = Color(0xFFFFFFFF); // White primary text
  static const Color textSecondaryDark =
      Color(0xFFD1D5DB); // Light gray secondary text
  static const Color textDisabledDark =
      Color(0xFF6B7280); // Medium gray disabled text
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme - Clean utility design
    ...
    // Bottom navigation for utility app navigation
    ...
    // Input decoration for forms and financial data entry
  ...
  static TextStyle dataTextStyleBold({required bool isLight}) {
    return GoogleFonts.jetBrainsMono(
      fontSize: 16,
      fontWeight: FontWeight.w600,
      color: isLight ? textPrimaryLight : textPrimaryDark,
